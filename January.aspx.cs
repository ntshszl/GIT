...

        {
            ...
            if (FileUploadExcel.HasFile)
            {
                try
                {
                    ...
                    OleDbCommand cmd = new OleDbCommand("Select * from [January$] WHERE [Warehouse] IS NOT NULL", OleDBcon);
                    OleDbCommand cmd2 = new OleDbCommand("Select * from [January$] WHERE [WAREHOUSE] IS NOT NULL", OleDBcon);
                    ...
                    SqlCommand cd = new SqlCommand("DELETE FROM jan_sum WHERE [Warehouse] = 'NISSIN PUNCAK ALAM ZONE 5' AND [Warehouse] IS NULL", con);
                    con.Open();
                    cd.ExecuteNonQuery();
                    ...
                    SqlCommand cd2 = new SqlCommand("DELETE FROM jan_search WHERE [WAREHOUSE2] = 'NISSIN PUNCAK ALAM ZONE 5' AND [WAREHOUSE2] IS NULL", cn);
                    cn.Open();
                    cd2.ExecuteNonQuery();
                    ...
                    try
                    {
                        bulkInsert.DestinationTableName = "jan_sum";
                        bulkInsert2.DestinationTableName = "jan_search";
                        ...
                        SqlCommand cd3 = new SqlCommand("DELETE FROM jan_search WHERE [WAREHOUSE2] IS NULL", c);
                        c.Open();
                        cd3.ExecuteNonQuery();
...

        {
            ...
            if (UploadExcel2.HasFile)
            {
                try
                {
                    ...
                    // SQL Delete Existing Data
                    SqlConnection con = new SqlConnection("Data Source=HMSB-M1LGPT0698\\SQLEXPRESS;Initial Catalog=git; Persist Security Info=True; User ID=Git;Password=Honda12345");
                    SqlCommand cd = new SqlCommand("DELETE FROM jan_sum WHERE [Warehouse] = 'NISSIN PUNCAK ALAM ZONE 7' AND [Warehouse] IS NULL", con);
                    con.Open();
                    cd.ExecuteNonQuery();

                    SqlConnection cn = new SqlConnection("Data Source=HMSB-M1LGPT0698\\SQLEXPRESS;Initial Catalog=git; Persist Security Info=True; User ID=Git;Password=Honda12345");
                    SqlCommand cd2 = new SqlCommand("DELETE FROM jan_search WHERE [WAREHOUSE2] = 'NISSIN PUNCAK ALAM ZONE 7' AND [WAREHOUSE2] IS NULL", cn);
                    cn.Open();
                    cd2.ExecuteNonQuery();
...

        {
            ...
            if (UploadExcel3.HasFile)
            {
                try
                {
                    ...
                    // SQL Delete Existing Data
                    SqlConnection con = new SqlConnection("Data Source=HMSB-M1LGPT0698\\SQLEXPRESS;Initial Catalog=git; Persist Security Info=True; User ID=Git;Password=Honda12345");
                    SqlCommand cd = new SqlCommand("DELETE FROM jan_sum WHERE [Warehouse] = 'SCHENKER' AND [Warehouse] IS NULL", con);
                    con.Open();
                    cd.ExecuteNonQuery();

                    SqlConnection cn = new SqlConnection("Data Source=HMSB-M1LGPT0698\\SQLEXPRESS;Initial Catalog=git; Persist Security Info=True; User ID=Git;Password=Honda12345");
                    SqlCommand cd2 = new SqlCommand("DELETE FROM jan_search WHERE [WAREHOUSE2] = 'SCHENKER' AND [WAREHOUSE2] IS NULL", cn);
                    cn.Open();
                    cd2.ExecuteNonQuery();
...

        {
            ...
            if (UploadExcel4.HasFile)
            {
                try
                {
                    ...
                    // SQL Delete Existing Data
                    SqlConnection con = new SqlConnection("Data Source=HMSB-M1LGPT0698\\SQLEXPRESS;Initial Catalog=git; Persist Security Info=True; User ID=Git;Password=Honda12345");
                    SqlCommand cd = new SqlCommand("DELETE FROM jan_sum WHERE [Warehouse] = 'TIONG NAM' AND [Warehouse] IS NULL", con);
                    con.Open();
                    cd.ExecuteNonQuery();

                    SqlConnection cn = new SqlConnection("Data Source=HMSB-M1LGPT0698\\SQLEXPRESS;Initial Catalog=git; Persist Security Info=True; User ID=Git;Password=Honda12345");
                    SqlCommand cd2 = new SqlCommand("DELETE FROM jan_search WHERE [WAREHOUSE2] = 'TIONG NAM' AND [WAREHOUSE2] IS NULL", cn);
                    cn.Open();
                    cd2.ExecuteNonQuery();
