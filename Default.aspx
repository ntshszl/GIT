<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="_Git_._Default" %>
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <asp:Label ID="tw" runat="server" Text="Label"></asp:Label>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <asp:Label ID="ts" runat="server" Text="Label"></asp:Label>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-auto">
                                                <asp:Label ID="inc" runat="server" Text="Label"></asp:Label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <asp:Label ID="og" runat="server" Text="Label"></asp:Label>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow mb-3">
                            <div class="card-header">
                                <h6 class="mt-2 font-weight-bold text-primary">Summary</h6>
                            </div>
                            <div class="card-body">
