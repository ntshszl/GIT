...
namespace _Git_
{
    public partial class SepSearch : System.Web.UI.Page
    {
        ...
        protected void ButSearch_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * FROM sep_search where lotno LIKE '%'+@lotno+'%' OR invoiceno LIKE '%'+@invoiceno+'%'", con);
            con.Open();
