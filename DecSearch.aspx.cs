...
namespace _Git_
{
    public partial class DecSearch : System.Web.UI.Page
    {
        ...
        protected void ButSearch_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT * FROM dec_search where lotno LIKE '%'+@lotno+'%' OR invoiceno LIKE '%'+@invoiceno+'%'", con);
            con.Open();
