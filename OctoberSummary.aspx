<%@ Page Title="October Summary" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OctoberSummary.aspx.cs" Inherits="_Git_.OctoberSummary" %>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow mb-3">
                            <div class="card-header">
                                <h6 class="mt-2 font-weight-bold text-primary">Summary of October</h6>
                            </div>
                            <div class="card-body">
