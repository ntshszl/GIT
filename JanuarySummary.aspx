<%@ Page Title="January Summary" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="JanuarySummary.aspx.cs" Inherits="_Git_.JanuarySummary" %>
                    ...
                    <div class="col-lg-12">
                        <div class="card shadow mb-3">
                            <div class="card-header">
                                <h6 class="mt-2 font-weight-bold text-primary">Summary of January</h6>
                            </div>
                            <div class="card-body">
